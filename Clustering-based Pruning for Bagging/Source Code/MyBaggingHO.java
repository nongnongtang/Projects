...
public class MyBaggingHO extends RandomizableParallelIteratedSingleClassifierEnhancer
{
  ...
  */
  ...
  public void buildClassifier(Instances data) throws Exception {
	...
	int trainSize = (int) Math.round(m_data.size() * 90 / 100);
    int testSize = m_data.size() - trainSize;
	m_data.randomize(random);
    Instances     train = new Instances(m_data, 0, trainSize);
    Instances      test = new Instances(m_data, trainSize, testSize);
    ...
    Instances probsOfClassifers = validateClassifiers(test); 
...
// add a new optioner for clustering classifiers
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MyBaggingHO\n\n");
  ...
  */
  ...
  public static void main(String [] argv) {
    runClassifier(new MyBaggingHO(), argv);
  }
}